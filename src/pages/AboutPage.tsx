...
export default function AboutPage() {
  return (
    ...
    >
      ...
      <button
        className="fixed bottom-8 right-8 w-14 h-14 rounded-full flex items-center justify-center z-[50] cursor-pointer hover:scale-110 transition-transform"
        style={{
      ...
      >
        ...
        >
          <path
            d="M20 2H4C2.9 2 2 2.9 2 4V22L6 18H20C21.1 18 22 17.1 22 16V4C22 2.9 21.1 2 20 2ZM13 14H11V12H13V14ZM13 10H11V6H13V10Z"
            fill="white"
          />
        </svg>
      </button>
