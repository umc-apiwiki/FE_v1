  ...
  return (
    <div>
      ...
      <div className="mb-6 xs:mb-8 md:mb-10">
        <span className="text-base xs:text-lg md:text-xl lg:text-[22px] font-medium text-info-darker">설명</span>
      ...
      {categories.length > 0 && (
        <div className="z-10">
          <span className="text-base xs:text-lg md:text-xl lg:text-[22px] font-medium text-info-darker">카테고리</span>
